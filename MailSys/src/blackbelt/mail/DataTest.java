...
public class DataTest extends Thread{
	...
	public void run(){
		...
		//init date
		mailService.send(" blllllllaaaaaaaaaaaaaaaaa ",MainSubject.ANSWER_IN_FORUM,"Ce message ne sert a rien.Go te chercher un café.",1L,MailType.GROUPABLE);
		mailService.send(" blllllllaaaaaaaaaaaaaaaaa ",MainSubject.ANSWER_IN_FORUM,"Ce message ne sert a rien.Go te chercher un café.",2L,MailType.GROUPABLE);
		mailService.send(" blllllllaaaaaaaaaaaaaaaaa ",MainSubject.ANSWER_IN_FORUM,"Ce message ne sert a rien.Go te chercher un café.",3L,MailType.GROUPABLE);
		mailService.send(" blllllllaaaaaaaaaaaaaaaaa ",MainSubject.ANSWER_FROM_COACH,"Ce message ne sert a rien.Go te chercher un café.",4L,MailType.GROUPABLE);
		mailService.send(" blllllllaaaaaaaaaaaaaaaaa ",MainSubject.ANSWER_FROM_COACH,"Ce message ne sert a rien.Go te chercher un café.",5L,MailType.GROUPABLE);
		mailService.send(" blllllllaaaaaaaaaaaaaaaaa ",MainSubject.ANSWER_FROM_COACH,"Ce message ne sert a rien.Go te chercher un café.",6L,MailType.GROUPABLE);
		mailService.send(" blllllllaaaaaaaaaaaaaaaaa ",MainSubject.ANSWER_FROM_COACH,"Ce message ne sert a rien.Go te chercher un café.",7L,MailType.GROUPABLE);
		...
		mailService.send(" message 1 ",MainSubject.REMINDER, "contenu de la mort qui tue, blablabla.blablabla blabla blablabla.blabla blablabla blablablabla blabla.", 1L,MailType.GROUPABLE);
		mailService.send(" message 2 ",MainSubject.CONGRATULATION, "contenu de. la mort qui tue, again.", 1L,MailType.IMMEDIATE);
		mailService.send(" message 3 - 1",MainSubject.REMINDER, "deuxieme contenu de la mort qui tue 1, plusieur fois.", 1L,MailType.GROUPABLE);
		...
		mailService.send(" message 6 ",MainSubject.REMINDER, "blablabla. blablabla blabla.", 2L,MailType.GROUPABLE);
