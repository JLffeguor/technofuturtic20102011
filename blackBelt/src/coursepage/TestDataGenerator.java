...
public class TestDataGenerator {
	...
	public void generate() {
		...
		Section section61 = new Section("6.1 Preparation", "Have Eclipse and your DB ready, with all the needed jar files and jdbc driver. Have a persistence.xml ready. If you use Spring, prepare your applicationContext.xml file.\n\n"
		...
		Section section62 = new Section("6.2 Domain Model", "In the Wow game  (<i>World of Warcraft</i>), players group and kill bosses in dungeons. \n\n"
										+ "A dungeon is a place with rooms and monsters. Imagine it's a building. Once you enter the building, you start killing monsters, for example the receptionist.\n\n"
										+ "If another group of player decides to enter in the same dungeon (the building) they will see their own \"instance\" of the dungeon, where the receptionist is still alive. Each group entering in a dungeon has its own DungeonInstance."
										+ "A Dungeon is like a map defining the rooms of the building and the kind of monsters out there.\n\n "
										+ "A DungeonInstance is like a game memory remembering which monster is alive or dead for the playing group. But that notion of alive/dead monster is out of the scope of this project.\n\n"
		...
		Section section63 = new Section("6.3 Data", "In this project, we modelize 2 dungeons: "
										...
										+ "This is how the Nexus dungeon looks like from the outside: [image src=\"S:\\DocumentsPourPDF\\images\\The_Nexus.JPG\"/] \n\n"
										...
										+ "That group decides to enter into the Nexus dungeon. The system creates a DungeonInstance. \n\n"
										+ "[code escape=\"true\"]Nexus:Dungeon <- :DungeonInstance <-> :Group <- A, B, C, D [/code] \n\n"
										+ "Another group of players (E, F and G) decides to play the same dungeon. Another DungeonInstance is created in the DB, also bound to Nexus. \n\n"
										+ "A third group of players (H, I, J, K and L) decides to play together, but in the other Dugeon: <i>Gundrak</i>. A corresponding DungeonInstance is created. \n\n"
		...
		Section section65 = new Section("6.5 Optional Query", "Stop your timer now, before doing this last optional part: you are finished ;-)\n\n "
										+ "<b>This last query is not part of the test</b> \n\n"
