...
public class TestDataGenerator {
	...
	public void generate() {
		...
		Section section112 = new Section("1.1.2. Throwing Runtime Exceptions", "If some conditions aren't met in your program you may want to throw an Exception.</p>[video id  = \"http://www.kikibese.fr\" type = \"youtube\"] The syntax is easy, simply use the throw keyword and a new instance of a RuntimeException.See the below example:[code]public class BankAccount {     private String accountNumber;     private double balance;      // Constructors, getters & setters ...      public void debitAccount(double amount) {         if(balance < amount){             throw new RuntimeException(\"Balance too low to execute debit. \" + accountNumber);         }         balance -= amount;     } }[/code]");
