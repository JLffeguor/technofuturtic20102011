...
public class TestDataGenerator {
	...
	public void generate() {
		...
		Section section1131 = new Section(
				"1.1.3.1. Et voila ^^","Et ici les toutes dernières nouveautés...:  \"Un hamster qui rote ressemble" +
		...
		section111.getSubSections().add(section1131);
	}
