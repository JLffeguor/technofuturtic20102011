	...
	public void generate() {
		...
		Section section1131 = new Section(
				...
				Section section1132 = new Section(
						...
						+ "juridique. C'est le cas par exemple du hamster d'Europe en Alsace ou du Hamster doré en Syrie[7].");
		Section section111 = new Section(
				"1.1.1. Exercice",
				"<p>Execute the following steps</p></br><ul><p>    </p><li>Run a program that throws a NullPointerException " +
				...
				"[attachment<a href=\"/gen/course/11185838/OO4 - Inheritence copy.pdf\"><img align=\"middle\" src=\"S:\\DocumentsPourPDF\\OO4 - Inheritence copy.pdf\" style=\"border: medium none;\"></a>]");
